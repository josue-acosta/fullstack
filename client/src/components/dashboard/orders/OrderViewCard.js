...
const OrderViewCard = ({ orderNumber, name, phoneNumber, dateTime, cakeSize, flavor1, flavor2, filling, decoration, printOut, celebratedName, celebratedAge, celebratedText, price }) => {
